...
//                        Toaster.show("download rate:" + extra);
    ...
    public void setShowMusic(boolean show) {
        $.id(R.id.app_video_finish).visibility(show ? View.VISIBLE : View.GONE);
        $.id(R.id.app_video_replay).visibility(show ? View.VISIBLE : View.GONE);
        $.id(R.id.app_video_center_box).visibility(show ? View.VISIBLE : View.GONE);
        $.id(R.id.app_video_status).visibility(show ? View.VISIBLE : View.GONE);
        $.id(R.id.app_video_loading).visibility(show ? View.VISIBLE : View.GONE);
